...
/**
 * Command to load the Store Pickup data by specified identifier
 * @api
 */
interface GetStorePickupByIdentifierInterface
{
    /**
     * Load page data by given Store Pickup identifier.
     *
